...
class App:
    ...
    def create_widgets(self):
        ...
        # Tạo Treeview hiển thị kết quả
        self.result_tree = ttk.Treeview(self.root, columns=("File", "Kết quả"), show="headings")
    ...
    def encrypt_file(self):
        try:
            ...
            self.result_tree.delete(*self.result_tree.get_children())  # Xóa kết quả cũ
    ...
    def decrypt_file(self):
        try:
            ...
            # Đọc data.txt
            file_dict = self.load_file_dict(data_path, os.path.basename(file_name))
    ...
    def encrypt_directory(self):
        ...
        with open(os.path.join(dir_name, 'key.key'), 'wb') as key_file:
            key_file.write(key)
        file_dict = {}
        self.result_tree.delete(*self.result_tree.get_children())  # Xóa dữ liệu cũ trong Treeview
            ...
            for file in files:
                if file != 'key.key' and file != 'data.txt':
                    try:
                        ...
                        self.result_tree.insert("", "end", values=(file, f"Lỗi: {str(e)}"))
                ...
                if file.endswith('.ecrb'):
                    ...
                    with open(os.path.join(dir_name, 'data.txt'), 'r') as f:
                        ...
                        if original_file_name:
                            ...
                            self.result_tree.insert("", "end", values=(file, "Không tìm thấy tên file cũ trong data.txt."))
