...
class PDFPasswordProtector:
    def __init__(self, root):
        self.root = root
        self.root.title("PDF Password Protector")
        ...
        self.notebook.add(self.folder_tab, text="Folder")
    ...
    def setup_single_file_tab(self):
        ...
        # Password
        ttk.Label(self.single_file_tab, text="Password:").grid(row=2, column=0, sticky='w', pady=5)
        ...
        # Start button
        self.single_start_btn = ttk.Button(self.single_file_tab, text="Start", command=self.start_single_file)
    ...
    def setup_folder_tab(self):
        ...
        # Password
        ttk.Label(self.folder_tab, text="Password:").grid(row=2, column=0, sticky='w', pady=5)
        ...
        # Start button
        self.folder_start_btn = ttk.Button(self.folder_tab, text="Start", command=self.start_folder)
    ...
    def process_folder(self):
        try:
            ...
            self.log_message(f"   ✅ PDF files processed: {pdf_count}")
