# Topics registry (AskCpl)

| ID | Topic | Roadmap |
|---|---|---|
| an_toan_vat_lieu_do_choi_so_sinh | An toàn vật liệu & Tiêu chuẩn đồ chơi trẻ em 0-3 tuổi (EN71 / ASTM F963 / ISO 8124) | roadmap_Tao_do_choi_0-25_tuoi.md |
| dung_cu_cat_dan_xu_ly_rac_tai_che | Dụng cụ cắt dán & Kỹ thuật xử lý rác tái chế an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| lam_chai_cam_quan_sensory_bottle | Chế tạo Chai Cảm Quan (Sensory Bottle) Kích Thích Thị Giác | roadmap_Tao_do_choi_0-25_tuoi.md |
| tu_che_luc_lac_am_thanh_tu_co_ban | Tự chế Lục Lạc Âm Thanh Tương Tác từ vật liệu tái chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| ontap_bo_do_choi_xuc_giac_thinh_giac | Đánh giá & Hoàn thiện Bộ sưu tập Cảm quan Thị giác - Thính giác | roadmap_Tao_do_choi_0-25_tuoi.md |
| lam_flashcard_xuc_giac_tu_vai_vun | Kỹ thuật làm Thẻ Flashcard Xúc Giác đa bề mặt | roadmap_Tao_do_choi_0-25_tuoi.md |
| thiet_ke_thap_xep_chong_bia_carton | Thiết kế & Chế tạo Tháp Xếp Chồng từ bìa cứng tái chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| son_mau_an_toan_khong_doc_hai | Trang trí, Phủ sơn màu an toàn (Non-toxic) & Chống thấm đồ chơi | roadmap_Tao_do_choi_0-25_tuoi.md |
| ontap_kiem_dinh_an_toan_do_choi | Review & Rà soát tiêu chuẩn an toàn tổng thể theo EN71 / ISO 8124 | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_cam_quan_0_3_tuoi | Capstone Project: Bộ Đồ Chơi Phát Triển Cảm Quan Toàn Diện Cho Bé 0-3 Tuổi | roadmap_Tao_do_choi_0-25_tuoi.md |
| khai_niem_do_choi_tu_duy_3_6_tuoi | Đặc điểm phát triển và tiêu chuẩn an toàn đồ chơi trẻ 3-6 tuổi | roadmap_Tao_do_choi_0-25_tuoi.md |
| thiet_ke_bang_ban_ron_busy_board | Thiết kế khung và chọn chi tiết cho Bảng bận rộn (Busy Board) | roadmap_Tao_do_choi_0-25_tuoi.md |
| thuc_hanh_lap_rap_busy_board | Thực hành lắp ráp, gia cố và xử lý bề mặt Bảng bận rộn | roadmap_Tao_do_choi_0-25_tuoi.md |
| ontap_quy_trinh_busy_board | Ôn tập và kiểm định độ bền, va đập cho Bảng bận rộn | roadmap_Tao_do_choi_0-25_tuoi.md |
| lam_mo_hinh_phan_loai_hinh_khoi_mau_sac | Làm mô hình hộp thả hình khối và phân loại màu sắc logic | roadmap_Tao_do_choi_0-25_tuoi.md |
| thiet_ke_duong_ray_bong_lan_ong_giay | Thiết kế đường ray bóng lăn (Marble Run) bằng ống giấy tái chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| tuy_chinh_do_doc_duong_ray_ong_giay | Điều chỉnh độ dốc và xử lý sự cố kẹt bóng đường ray | roadmap_Tao_do_choi_0-25_tuoi.md |
| lam_roi_ngon_tay_ke_cau_chuyen | May cắt rối ngón tay bằng vải nỉ và kịch bản tương tác ngôn ngữ | roadmap_Tao_do_choi_0-25_tuoi.md |
| ontap_danh_gia_do_choi_kheo_tay | Ôn tập, đánh giá độ bền và tổng hợp các dự án khéo tay | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_logic_van_dong_tinh | Capstone: Hoàn thiện Bộ đồ chơi Logic & Vận động tinh 3-6 tuổi | roadmap_Tao_do_choi_0-25_tuoi.md |
| tong_quan_stem_va_nguyen_ly_co_hoc | Nhập môn STEM, nguyên lý cơ học & an toàn vật liệu/hóa chất | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_phan_luc_bong_bay | Chế tạo xe chạy bằng phản lực khí bong bóng | roadmap_Tao_do_choi_0-25_tuoi.md |
| toi_uu_truc_banh_xe_phan_luc | Tối ưu hóa bánh xe, giảm ma sát và xử lý sự cố xe phản lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| ontap_dong_luc_hoc_khi_nen | Ôn tập, kiểm thử va đập và xử lý sự cố động lực học khí nén | roadmap_Tao_do_choi_0-25_tuoi.md |
| canh_tay_thuy_luc_khung_carton | Thiết kế bộ khung carton cho cánh tay robot thủy lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| he_thong_xi_lanh_truyen_luc_thuy_luc | Lắp đặt hệ thống xi-lanh truyền lực bằng chất lỏng và xử lý rò rỉ | roadmap_Tao_do_choi_0-25_tuoi.md |
| may_chieu_phim_mini_kinh_lup | Chế tạo máy chiếu phim mini từ kính lúp và hộp bìa sơn chống ẩm | roadmap_Tao_do_choi_0-25_tuoi.md |
| ontap_thuy_luc_va_quang_hoc_do_choi | Ôn tập ứng dụng thủy lực, quang học và kiểm thử độ bền | roadmap_Tao_do_choi_0-25_tuoi.md |
| cam_bay_co_the_co_hoc_co_ty_phu | Thiết kế cạm bẫy cơ học Automata và chi tiết Pop-up cho bàn cờ tỷ phú | roadmap_Tao_do_choi_0-25_tuoi.md |
| coi_xay_gio_hoac_guong_nuoc_phat_dien | Lắp ráp mô hình cối xay gió / guồng nước và nhập môn mạch điện DC đơn giản | roadmap_Tao_do_choi_0-25_tuoi.md |
| ontap_kiem_thu_mo_hinh_stem | Ôn tập, kiểm thử va đập Drop Test & Đánh giá hiệu suất các mô hình STEM | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_san_pham_stem_thong_minh | Capstone Project: Bộ đồ chơi STEM Động lực học, Cơ học & Điện tử thông minh | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_kien_truc_carton_que_kem | Kỹ thuật thiết kế mô hình kiến trúc thu nhỏ bằng carton và que kem | roadmap_Tao_do_choi_0-25_tuoi.md |
| thiet_ke_ket_cau_cau_day_vang_truss | Thiết kế kết cấu cầu dây văng và giàn không gian chịu lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| ontap_ky_thuat_kien_truc_chiu_luc | Ôn tập và kiểm thử tải trọng mô hình kiến trúc chịu lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| thiet_ke_ban_co_giai_tri_nhom | Chế tạo bàn cờ giải trí nhóm từ carton cứng và gỗ ép | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_phu_kien_ban_co_thap_xi_ngau | Chế tạo phụ kiện tháp đổ xí ngầu và quân cờ thủ công | roadmap_Tao_do_choi_0-25_tuoi.md |
| ontap_hoan_thien_bo_do_choi_board_game | Ôn tập và kiểm thử trải nghiệm bộ đồ chơi Board Game | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_che_tao_dieu_khi_dong_hoc | Kỹ thuật làm diều khí động học từ nan tre và vải bạt nhẹ | roadmap_Tao_do_choi_0-25_tuoi.md |
| be_phong_ten_lua_nuoc_khi_nen | Chế tạo bệ phóng tên lửa nước khí nén an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| toi_uu_khi_dong_hoc_va_ap_suat_phong | Tối ưu hóa cánh đuôi, đầu đạn và áp suất phóng tên lửa nước | roadmap_Tao_do_choi_0-25_tuoi.md |
| ontap_kiem_thu_do_choi_da_ngoai | Ôn tập và kiểm thử vận hành thực địa các đồ chơi dã ngoại | roadmap_Tao_do_choi_0-25_tuoi.md |
| lam_den_trang_tri_nghe_thuat_diy | Chế tạo đèn ngủ và đèn trang trí chiếu sáng nghệ thuật | roadmap_Tao_do_choi_0-25_tuoi.md |
| lam_ke_treo_tuong_khay_to_chuc_do_dac | Chế tạo kệ treo tường và khay tổ chức đồ dùng từ gỗ/carton | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_mo_hinh_da_ngoai_decor_doi_song | Capstone Project: Bộ sưu tập mô hình kỹ thuật, đồ dã ngoại và decor sinh hoạt | roadmap_Tao_do_choi_0-25_tuoi.md |
| tieu_chuan_an_toan_en71 | Tìm hiểu tiêu chuẩn an toàn đồ chơi EN71, ASTM F963 và ISO 8124 | roadmap_Tao_do_choi_0-25_tuoi.md |
| phan_loai_vat_lieu_tai_che | Lựa chọn, xử lý và kiểm soát chất lượng vật liệu tái chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_cat_dan_an_toan | Kỹ thuật cắt dán, bo tròn cạnh và kiểm thử liên kết keo | roadmap_Tao_do_choi_0-25_tuoi.md |
| do_choi_thi_giac_tuong_phan | Nguyên lý thiết kế đồ chơi kích thích thị giác | roadmap_Tao_do_choi_0-25_tuoi.md |
| thuc_hanh_bo_the_thi_giac | Thực hành làm bộ thẻ và mô hình treo nôi thị giác | roadmap_Tao_do_choi_0-25_tuoi.md |
| do_choi_phat_trien_thinh_giac | Chế tạo đồ chơi phát triển thính giác an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_kiem_thu_an_toan | Ôn tập và kiểm thử an toàn đồ chơi thị giác, thính giác | roadmap_Tao_do_choi_0-25_tuoi.md |
| do_choi_xuc_giac_quiet_book | Nguyên lý thiết kế đồ chơi kích thích xúc giác | roadmap_Tao_do_choi_0-25_tuoi.md |
| thuc_hanh_tham_cam_quan | Thực hành chế tạo thảm cảm quan đa bề mặt | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_cam_quan | Capstone: Hoàn thiện bộ đồ chơi cảm quan đa giác quan 0-3 tuổi | roadmap_Tao_do_choi_0-25_tuoi.md |
| nguyen_ly_van_dong_tinh_3_6_tuoi | Nguyên lý vận động tinh và tư duy logic lứa tuổi 3-6 | roadmap_Tao_do_choi_0-25_tuoi.md |
| thiet_ke_busy_board_logic | Thiết kế Bảng bận rộn (Busy Board) phát triển kỹ năng sống | roadmap_Tao_do_choi_0-25_tuoi.md |
| gia_cong_busy_board | Gia công và lắp ráp Bảng bận rộn hoàn chỉnh | roadmap_Tao_do_choi_0-25_tuoi.md |
| thiet_ke_hop_tha_hinh_khoi | Thiết kế và chế tạo Hộp thả hình khối (Shape Sorter) | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_co_cau_chuyen_dong_an_toan | Ôn tập và kiểm thử cơ cấu chuyển động an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| thiet_ke_duong_ray_bong_lan | Thiết kế Đường ray bóng lăn (Ball Run/Marble Run) | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_roi_ngon_tay_ngon_ngu | Chế tạo Rối ngón tay hỗ trợ phát triển ngôn ngữ | roadmap_Tao_do_choi_0-25_tuoi.md |
| kich_ban_ke_chuyen_roi_ngon_tay | Xây dựng kịch bản tương tác và kể chuyện với rối ngón tay | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_toi_uu_do_choi_logic | Ôn tập và tối ưu hóa bộ đồ chơi logic - vận động | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_logic_van_dong | Capstone: Chế tạo Bộ Đồ Chơi Logic & Vận Động Tinh Hoàn Chỉnh | roadmap_Tao_do_choi_0-25_tuoi.md |
| tong_quan_stem_co_hoc_dong_luc | Tổng quan Đồ chơi STEM & Khái niệm Động lực học cơ bản | roadmap_Tao_do_choi_0-25_tuoi.md |
| nguyen_ly_khi_nen_xe_bong_bay | Nguyên lý Khí nén & Thiết kế Xe khí nén bóng bay | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_xe_khi_nen | Thực hành Chế tạo Xe khí nén & Tối ưu chuyển động | roadmap_Tao_do_choi_0-25_tuoi.md |
| nguyen_ly_thuy_luc_xi_lanh | Nguyên lý Thủy lực Pascal & Ứng dụng Xi-lanh bơm tiêm | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_canh_tay_thuy_luc_co_ban | Chế tạo Cánh tay thủy lực nâng hạ đơn giản | roadmap_Tao_do_choi_0-25_tuoi.md |
| nang_cap_canh_tay_thuy_luc_da_truc | Nâng cấp Cánh tay thủy lực xoay & kẹp vật thể | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_co_hoc_khi_nen_thuy_luc | Ôn tập & Kiểm thử độ bền cơ học Đồ chơi Thủy lực/Khí nén | roadmap_Tao_do_choi_0-25_tuoi.md |
| quang_hoc_may_chieu_mini | Quang học nhập môn & Nguyên lý Máy chiếu mini | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_may_chieu_mini_carton | Chế tạo Máy chiếu mini từ Thấu kính & Hộp carton | roadmap_Tao_do_choi_0-25_tuoi.md |
| mach_dien_dc_co_ban | Mạch điện DC cơ bản: Nguồn, Công tắc, Đèn LED & Động cơ | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_mo_hinh_mach_dien_dc | Chế tạo Mô hình Đèn pin / Quạt mini chạy điện DC | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_stem_tong_hop | Capstone: Thiết kế & Chế tạo Bộ đồ chơi STEM Cơ-Điện-Quang | roadmap_Tao_do_choi_0-25_tuoi.md |
| co_hoc_ket_cau_cau_chiu_luc | Cơ học kết cấu và nguyên lý cầu chịu lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| lap_rap_mo_hinh_cau_que_kem | Chế tạo mô hình cầu chịu lực từ que gỗ | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_thu_tai_cau_chiu_luc | Ôn tập và thử nghiệm đo lực chịu tải của cầu | roadmap_Tao_do_choi_0-25_tuoi.md |
| thiet_ke_board_game_luat_choi | Thiết kế luật chơi và cơ chế Board Game nhóm | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_ban_co_linh_kien | Gia công bàn cờ và sản xuất quân cờ thủ công | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_can_bang_board_game | Ôn tập và thử nghiệm cân bằng Board Game | roadmap_Tao_do_choi_0-25_tuoi.md |
| khi_dong_hoc_dieu_bay | Khí động học ứng dụng trong thiết kế diều | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_dieu_khi_dong_hoc | Chế tạo và cân bằng diều khí động học dã ngoại | roadmap_Tao_do_choi_0-25_tuoi.md |
| nguyen_ly_ten_lua_nuoc | Nguyên lý áp suất nén và khí động học tên lửa nước | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_ten_lua_nuoc_be_phong | Chế tạo tên lửa nước và hệ thống bệ phóng an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_mo_hinh_da_ngoai_stem | Capstone Phase 4: Ngày hội dã ngoại STEM và thi đấu mô hình | roadmap_Tao_do_choi_0-25_tuoi.md |
| tong_quan_decor_nghe_thuat_khong_gian | Tổng quan Decor Nghệ thuật & Nguyên lý Thẩm mỹ Không gian | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_che_tac_den_chieu_sang_ambient | Kỹ thuật Chế tác Đèn chiếu sáng Ambient Nghệ thuật & An toàn Nguồn điện | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_den_ngu_do_bong_shadow_lamp | Thực hành Chế tạo Đèn ngủ Đổ bóng Shadow Lamp & Tản nhiệt Nghệ thuật | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_duc_resin_vua_xi_mang_decor | Kỹ thuật Đúc Resin & Vữa Xi măng Tạo hình Khay Decor (Tuân thủ An toàn Hóa chất) | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_san_pham_trang_tri_de_ban | Ôn tập & Kiểm định An toàn Đồ trang trí Để bàn Nghệ thuật | roadmap_Tao_do_choi_0-25_tuoi.md |
| nguyen_ly_thiet_ke_ke_treo_tuong_mo_dun | Nguyên lý Thiết kế Kệ Treo tường Mô-đun Tiện ích & Kết cấu Chịu lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| gia_cong_ke_to_chuc_do_dac_thu_cong | Thực hành Gia công Kệ Tổ chức Đồ đạc Thủ công & Quy tắc Cắt gọt An toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_macrame_string_art_nghe_thuat | Kỹ thuật Macrame & String Art Trang trí Treo tường Nghệ thuật | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_kiem_thu_do_ben_tinh_thuc_tien | Ôn tập & Kiểm thử Độ bền, Thử nghiệm Lão hóa & Kháng ẩm mốc | roadmap_Tao_do_choi_0-25_tuoi.md |
| nghe_thuat_tai_che_decor_industrial | Nghệ thuật Tái chế Phế liệu thành Tác phẩm Decor Industrial Tương tác | roadmap_Tao_do_choi_0-25_tuoi.md |
| toi_uu_be_mat_phu_son_chong_am_moc | Tối ưu hóa Bề mặt, Phủ sơn PU & Xử lý Chống ẩm mốc An toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_suu_tap_decor_va_den_nghe_thuat | Capstone: Bộ sưu tập Decor Không gian sống & Đèn Nghệ thuật Hoàn chỉnh | roadmap_Tao_do_choi_0-25_tuoi.md |
| phan_biet_vat_lieu_an_toan | Phân biệt & Lựa chọn Vật liệu An toàn Cho Trẻ 0-3 Tuổi | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_cat_mai_bo_tron_go | Kỹ thuật Cắt Phôi & Mài Bo Tròn Góc Gỗ Cơ Bản | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_son_phu_go_an_toan | Kỹ thuật Sơn & Phủ Bề Mặt An Toàn Bằng Dầu Thực Vật/Sơn Gốc Nước | roadmap_Tao_do_choi_0-25_tuoi.md |
| bo_the_thi_giac_tuong_phat | Thiết kế & Chế tạo Bộ Thẻ Thị Giác Đen-Trắng-Đỏ Tương Phản Cao | roadmap_Tao_do_choi_0-25_tuoi.md |
| chuong_lac_thinh_giac_go | Chế tạo Chuông Lắc Thính Giác Bằng Gỗ & Hạt Đậu Tự Nhiên | roadmap_Tao_do_choi_0-25_tuoi.md |
| the_xuc_giac_da_chat_lieu | Làm Bộ Thẻ Cảm Nhận Xúc Giác Đa Bề Mặt | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_kiem_dinh_an_toan | Ôn tập & Kiểm định An toàn Cơ học / Cảm quan Cho Sản Phẩm Trẻ Em | roadmap_Tao_do_choi_0-25_tuoi.md |
| thap_vong_go_van_dong_tinh | Thiết kế & Gia công Tháp Chồng Vòng Gỗ Kích Thích Vận Động Tinh | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_cam_quan_busy_board_mini | Chế tạo Bảng Cảm Quan Busy Board Mini Cho Trẻ 1-3 Tuổi | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_cam_quan_3in1 | Đồ Án Hoàn Thiện Bộ Đồ Chơi Kích Thích Cảm Quan 3 Trong 1 Cho Bé Sơ Sinh | roadmap_Tao_do_choi_0-25_tuoi.md |
| xu_ly_vai_va_bong_nhoi_an_toan | Xử lý vải xô cotton và bông nhồi kháng khuẩn an toàn cho bé | roadmap_Tao_do_choi_0-25_tuoi.md |
| bong_vai_cam_quan_da_gia_tri | Gia công bóng vải cảm quan ghép múi (Montessori Puzzle Ball) | roadmap_Tao_do_choi_0-25_tuoi.md |
| sach_vai_ky_nang_co_ban | May ghép trang sách vải kỹ năng (Quiet Book) - Khóa kéo & Cúc bấm | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_xu_ly_nhua_silicon_an_toan | Kỹ thuật kiểm tra và làm sạch Silicon thực phẩm (Food-grade silicone) | roadmap_Tao_do_choi_0-25_tuoi.md |
| vong_gam_nuou_go_silicon | Chế tạo vòng gặm nướu đa chất liệu Gỗ sồi & Silicon | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_ky_thuat_may_va_ghep_vat_lieu | Ôn tập và kiểm định độ bền mối nối may/ghép vải và gỗ silicon | roadmap_Tao_do_choi_0-25_tuoi.md |
| bo_hinh_khoi_cam_quan_vai_ni | Chế tạo bộ hình khối cảm quan bằng vải nỉ dầy (Sensory Shapes) | roadmap_Tao_do_choi_0-25_tuoi.md |
| trong_lan_cam_quan_go | Lắp ráp Trống lăn cảm quan bằng gỗ và thanh nan tròn (Rolling Drum) | roadmap_Tao_do_choi_0-25_tuoi.md |
| khoi_lap_phuong_ban_ron_vai | Chế tạo khối lập phương bận rộn bằng vải (Soft Busy Cube) | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_cam_quan_van_dong_toan_dien | Capstone Phase 1: Bộ sản phẩm Cảm quan - Vận động hoàn chỉnh cho bé 1-3 tuổi | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_xu_ly_giay_carton_an_toan | Kỹ thuật xử lý giấy và carton an toàn cho bé | roadmap_Tao_do_choi_0-25_tuoi.md |
| the_hoc_pop_up_don_gian | Thiết kế thẻ học cảm quan dạng nổi Pop-up | roadmap_Tao_do_choi_0-25_tuoi.md |
| hop_cam_quan_giau_do_vat | Chế tạo Hộp giấu đồ vật Montessori (Object Permanence Box) | roadmap_Tao_do_choi_0-25_tuoi.md |
| chai_cam_quan_dung_dich_long | Làm Chai cảm quan dung dịch lỏng chống rò rỉ | roadmap_Tao_do_choi_0-25_tuoi.md |
| do_choi_phat_am_thanh_tu_nhien | Chế tạo đồ chơi phát âm thanh từ vật liệu tự nhiên | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_kiem_dinh_do_ben_da_vat_lieu | Ôn tập & Thử nghiệm kiểm định độ bền đa vật liệu | roadmap_Tao_do_choi_0-25_tuoi.md |
| bo_tha_hinh_khoi_cam_quan | Gia công Bộ thả hình khối cảm quan đa bề mặt | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_luon_day_cam_quan_van_dong | Thiết kế Bảng luồn dây tập vận động tinh | roadmap_Tao_do_choi_0-25_tuoi.md |
| tham_cam_quan_di_chan_tran | Chế tạo Tấm thảm cảm quan bước chân (Sensory Path) | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_cam_quan_tong_hop | Capstone: Tích hợp Bộ Đồ Chơi Kích Thích Cảm Quan 0-3 Tuổi | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_su_dung_guong_an_toan_acrylic | Kỹ thuật ứng dụng gương Acrylic an toàn cho đồ chơi cảm quan | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_go_lan_cam_quan_hat_phat_tieng | Làm xe gỗ lăn kết hợp hạt âm thanh chuyển động | roadmap_Tao_do_choi_0-25_tuoi.md |
| dan_go_phat_nhac_cam_quan_don_gian | Chế tạo đàn gõ gỗ mini tạo âm thanh tự nhiên | roadmap_Tao_do_choi_0-25_tuoi.md |
| bo_ghep_doi_mau_sac_xuc_giac | Làm bộ đĩa ghép đôi màu sắc và kết cấu bề mặt | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_quy_trinh_hoan_thien_va_an_toan_tong_hop | Ôn tập quy trình kiểm định an toàn & kỹ thuật xử lý bề mặt đa vật liệu | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_ngoi_nha_cam_quan_p1_cat_phoi | Capstone Ngôi nhà cảm quan - Phần 1: Thiết kế và cắt phôi khung gỗ | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_ngoi_nha_cam_quan_p2_thi_giac_thinh_giac | Capstone Ngôi nhà cảm quan - Phần 2: Gia công mặt thị giác & thính giác | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_ngoi_nha_cam_quan_p3_xuc_giac_van_dong | Capstone Ngôi nhà cảm quan - Phần 3: Gia công mặt xúc giác & vận động tinh | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_ngoi_nha_cam_quan_p4_lap_rap_hoan_thien | Capstone Ngôi nhà cảm quan - Phần 4: Lắp ráp khung nhà & lau dầu hoàn thiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_ngoi_nha_cam_quan_p5_kiem_dinh_tong_ket | Capstone Ngôi nhà cảm quan - Phần 5: Kiểm định an toàn tổng thể & Đánh giá Phase 1 | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_xu_ly_day_cotton_len_tu_nhien | Kỹ thuật xử lý dây thừng cotton và len tự nhiên an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| do_choi_treo_noi_macrame_cotton | Thiết kế đồ chơi treo nôi gặm nướu đan macrame dây cotton | roadmap_Tao_do_choi_0-25_tuoi.md |
| tham_nuoc_cam_quan_tpu | Thiết kế thảm nước cảm quan màng TPU an toàn cho bé nằm sấp | roadmap_Tao_do_choi_0-25_tuoi.md |
| ong_day_luon_cam_quan_da_chat_lieu | Đồ chơi ống dây luồn cảm quan chuyển động đa chất liệu | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_xu_ly_vat_lieu_mem_va_chat_long | Ôn tập kỹ thuật xử lý vật liệu mềm và chất lỏng an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| bo_khoi_go_am_thanh_cam_quan | Bộ khối gỗ âm thanh khám phá thính giác và thị giác | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_banh_rang_go_guong_mini | Bảng chuyển động bánh răng gỗ và gương mini cảm quan | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_cay_cam_quan_p1_cat_phoi | Capstone Bộ cây cảm quan đa giác quan P1: Cắt phôi gỗ và tạo hình | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_cay_cam_quan_p2_lap_rap_son | Capstone Bộ cây cảm quan đa giác quan P2: Lắp ráp chi tiết cảm quan & Sơn an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_cay_cam_quan_p3_kiem_dinh_hoan_thien | Capstone Bộ cây cảm quan đa giác quan P3: Kiểm định an toàn & Hoàn thiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_xu_ly_dat_set_tu_kho_an_toan | Kỹ thuật xử lý đất sét tự khô an toàn và chẩn đoán lỗi nứt bề mặt | roadmap_Tao_do_choi_0-25_tuoi.md |
| bo_in_dau_tay_chan_dat_set_cam_quan | Thiết kế thẻ in vân tự nhiên bằng đất sét và khắc phục lỗi dính khuôn | roadmap_Tao_do_choi_0-25_tuoi.md |
| tui_gel_cam_quan_kim_tuyen | Kỹ thuật ép nhiệt túi gel cảm quan và xử lý sự cố rò rỉ, bọt khí | roadmap_Tao_do_choi_0-25_tuoi.md |
| vong_xoay_mau_sac_optics_cam_quan | Chế tạo vòng xoay hòa trộn màu sắc và hiệu chỉnh ma sát cơ học | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_xu_ly_vat_lieu_tao_hinh_mem_dinh_hinh | Ôn tập liên kết vật liệu dẻo và chẩn đoán sự cố theo tiêu chuẩn ISO 8124 | roadmap_Tao_do_choi_0-25_tuoi.md |
| hop_thinh_giac_bi_mat_go_hat | Chế tạo bộ hộp thính giác bí mật phân biệt cường độ âm thanh và xử lý bong dán keo | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_cam_quan_khoa_keo_mo_van | Lắp ráp bảng cảm quan cơ cấu đóng mở & Xử lý kẹt khóa | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_hop_bo_tro_cam_quan_p1_thiet_ke_cat_phoi | Capstone: Hộp đa năng kích thích cảm quan - Phần 1: Thiết kế & Cắt phôi khung gỗ | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_hop_bo_tro_cam_quan_p2_lap_mat_cam_quan | Capstone: Hộp đa năng kích thích cảm quan - Phần 2: Lắp đặt 4 mặt cảm quan tích hợp | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_hop_bo_tro_cam_quan_p3_kiem_dinh_hoan_thien | Capstone: Hộp đa năng kích thích cảm quan - Phần 3: Hoàn thiện, Phủ bóng & Kiểm định an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_busy_board_logic | Kỹ thuật thiết kế Busy Board phát triển tư duy logic và kỹ năng sống | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_busy_board_khoa_va_cong_tac | Lắp đặt ổ khóa cửa và công tắc đèn an toàn trên bảng bận rộn | roadmap_Tao_do_choi_0-25_tuoi.md |
| hop_phan_loai_hinh_khoi_3d_go | Chế tạo hộp phân loại hình khối 3D rèn luyện tư duy không gian | roadmap_Tao_do_choi_0-25_tuoi.md |
| duong_ray_bong_lan_do_doc_carton | Thiết kế và lắp dựng đường ray bóng lăn ziczac từ carton cứng | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_co_che_chuyen_dong_va_phan_loai | Ôn tập và đánh giá cơ chế chuyển động, phân loại hình khối | roadmap_Tao_do_choi_0-25_tuoi.md |
| roi_ngon_tay_vai_ni_ke_chuyen | May bộ rối ngón tay bằng vải nỉ phát triển ngôn ngữ và giao tiếp | roadmap_Tao_do_choi_0-25_tuoi.md |
| roi_que_go_nhan_vat_co_tich | Chế tạo rối que gỗ và sân khấu kịch bìa cứng kể chuyện cổ tích | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_busy_board_logic_p1_khung_va_khoa | Capstone 11: Bảng bận rộn Logic & Kỹ năng sống - Phần 1: Gia công khung gỗ và lắp cụm khóa | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_busy_board_logic_p2_banh_rang_day_giay | Capstone 11: Bảng bận rộn Logic & Kỹ năng sống - Phần 2: Lắp đặt bánh răng liên hoàn và mô hình tập buộc dây giày | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_busy_board_logic_p3_kiem_dinh_hoan_thien | Capstone 11: Bảng bận rộn Logic & Kỹ năng sống - Phần 3: Hoàn thiện đồng hồ kim, sơn phủ bóng và kiểm định tổng hợp | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_bang_ky_nang_song | Kỹ thuật thiết kế bảng thực hành kỹ năng sống cơ bản | roadmap_Tao_do_choi_0-25_tuoi.md |
| dong_ho_go_hoc_gio_logic | Chế tạo đồng hồ gỗ xoay kim học số và thời gian | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_thoi_tiet_lich_hoc_tap | Thiết kế bảng thời tiết và các mùa bằng gỗ nỉ | roadmap_Tao_do_choi_0-25_tuoi.md |
| san_khau_roi_bong_carton | Chế tạo sân khấu rối bóng carton phát triển ngôn ngữ | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_thiet_ke_do_choi_ngon_ngu_ky_nang_song | Ôn tập và kiểm định đồ chơi ngôn ngữ - kỹ năng sống | roadmap_Tao_do_choi_0-25_tuoi.md |
| duong_ray_bong_lan_ziczac_da_tang | Chế tạo đường ray bóng lăn ziczac 3 tầng đà rơi và chẩn đoán sự cố ma sát | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_tinh_hat_go_logic_toan | Thiết kế bảng tính hạt gỗ 3 cột phát triển tư duy toán học và kiểm soát dung sai | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_ky_nang_ngon_ngu_p1_khung | Capstone Bộ đồ chơi Kỹ năng & Ngôn ngữ - Phần 1: Gia công khung gỗ gập và đánh giá độ bền | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_ky_nang_ngon_ngu_p2_module | Capstone Bộ đồ chơi Kỹ năng & Ngôn ngữ - Phần 2: Lắp ráp module kỹ năng và sân khấu rối | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_ky_nang_ngon_ngu_p3_hoan_thien | Capstone Bộ đồ chơi Kỹ năng & Ngôn ngữ - Phần 3: Thử nghiệm tương tác, xử lý sự cố và kiểm định | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_me_cung_logic | Kỹ thuật thiết kế mê cung logic vận động tinh | roadmap_Tao_do_choi_0-25_tuoi.md |
| me_cung_hat_go_luon_day_3d | Chế tạo mê cung hạt gỗ luồn dây uốn cong 3D | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_that_day_giay_cai_khuy_ao | Chế tạo bảng rèn kỹ năng thắt dây giày và cài khuy áo | roadmap_Tao_do_choi_0-25_tuoi.md |
| duong_ray_bong_lan_pheu_xoay | Chế tạo đường ray bóng lăn phễu xoay chuyển động | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_thiet_ke_tu_duy_khong_gian | Ôn tập thiết kế đồ chơi tư duy không gian và vận động tinh | roadmap_Tao_do_choi_0-25_tuoi.md |
| roi_ngon_tay_gia_dinh_vai_ni | Thiết kế bộ rối ngón tay gia đình phát triển ngôn ngữ | roadmap_Tao_do_choi_0-25_tuoi.md |
| hop_phan_loai_chu_cai_ngon_ngu | Chế tạo hộp phân loại chữ cái và hình ảnh ngôn ngữ | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_me_cung_roi_p1_cat_phoi | Capstone: Bộ mê cung logic & rối kể chuyện - P1: Cắt phôi và tạo hình | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_me_cung_roi_p2_lap_rap | Capstone: Bộ mê cung logic & rối kể chuyện - P2: Lắp ráp module và vẽ trang trí | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_me_cung_roi_p3_kiem_dinh | Capstone: Bộ mê cung logic & rối kể chuyện - P3: Kiểm định an toàn, xử lý sự cố và hoàn thiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_can_bang_logic | Kỹ thuật thiết kế đòn bẩy cân bằng logic | roadmap_Tao_do_choi_0-25_tuoi.md |
| can_bang_ro_go_so_hoc | Cân bằng rổ gỗ số học phát triển tư duy toán học | roadmap_Tao_do_choi_0-25_tuoi.md |
| hop_phan_loai_mau_sac_va_so_luong | Hộp phân loại màu sắc và số lượng 4 ngăn | roadmap_Tao_do_choi_0-25_tuoi.md |
| duong_ray_bong_lan_ong_hut_nam_cam | Đường ray bóng lăn ghép nối ống hút nam châm | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_thiet_ke_do_choi_so_hoc_va_vat_ly_don_gian | Ôn tập thiết kế đồ chơi số học và cơ chế vật lý | roadmap_Tao_do_choi_0-25_tuoi.md |
| roi_ngon_tay_dong_vat_rung_xanh | Rối ngón tay động vật rừng xanh kích thích diễn đạt và xử lý sự cố mối khâu | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_banh_rang_truyen_dong_logic | Bảng bánh răng truyền động liên hoàn 5 trục và tinh chỉnh kẹt cơ cấu | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_logic_ngon_ngu_p1_thiet_ke_cat_phoi | Capstone Bộ đồ chơi Logic & Ngôn ngữ - Phần 1: Cắt phôi, lập BOM và tạo khung | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_logic_ngon_ngu_p2_lap_rap_module | Capstone Bộ đồ chơi Logic & Ngôn ngữ - Phần 2: Lắp ráp module logic, sân khấu rối và chẩn đoán sự cố | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_logic_ngon_ngu_p3_kiem_dinh_hoan_thien | Capstone Bộ đồ chơi Logic & Ngôn ngữ - Phần 3: Kiểm định an toàn, đánh giá độ bền và sơn phủ hoàn thiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_do_choi_bieu_cam_cam_xuc | Kỹ thuật thiết kế đồ chơi biểu cảm cảm xúc cho trẻ | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_xoay_bieu_cam_khuon_mat | Chế tạo bảng xoay biểu cảm khuôn mặt 3 tầng | roadmap_Tao_do_choi_0-25_tuoi.md |
| hop_phan_loai_bieu_cam_ngon_ngu | Hộp phân loại thẻ cảm xúc và tình huống xã hội | roadmap_Tao_do_choi_0-25_tuoi.md |
| duong_ray_bong_lan_co_cong_chuyen_huong | Chế tạo đường ray bóng lăn có cần gạt chuyển hướng | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_thiet_ke_do_choi_cam_xuc_va_co_che_dieu_huong | Ôn tập thiết kế đồ chơi cảm xúc và cơ chế điều hướng | roadmap_Tao_do_choi_0-25_tuoi.md |
| roi_ngon_tay_nghe_nghiep_xa_hoi | May bộ rối ngón tay vải nỉ chủ đề nghề nghiệp xã hội | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_busy_board_dien_led_an_toan | Chế tạo module mạch điện pin và đèn LED an toàn cho Busy Board | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_cam_xuc_ky_nang_p1_khung_layout | Capstone Bộ đồ chơi Cảm xúc & Kỹ năng Sống: Phần 1 - Thiết kế layout, hạch toán BOM và cắt khung | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_cam_xuc_ky_nang_p2_lap_rap_chi_tiet | Capstone Bộ đồ chơi Cảm xúc & Kỹ năng Sống: Phần 2 - Lắp ráp các module và hiệu chỉnh sự cố | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_cam_xuc_ky_nang_p3_kiem_dinh_hoan_thien | Capstone Bộ đồ chơi Cảm xúc & Kỹ năng Sống: Phần 3 - Kiểm định an toàn, hoàn thiện và đánh giá vòng đời | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_do_choi_phan_so_logic | Kỹ thuật thiết kế đồ chơi học phân số logic | roadmap_Tao_do_choi_0-25_tuoi.md |
| bo_ghep_hinh_phan_so_go_logic | Chế tạo bộ ghép hình phân số bằng gỗ | roadmap_Tao_do_choi_0-25_tuoi.md |
| hop_phan_loai_hinh_hoc_va_chu_ky_mau | Chế tạo hộp phân loại hình học và chu kỳ màu sắc | roadmap_Tao_do_choi_0-25_tuoi.md |
| duong_ray_bong_lan_thang_nang_tay_quay | Chế tạo đường ray bóng lăn có thang nâng tay quay | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_co_che_phan_so_va_thang_nang_co_hoc | Ôn tập cơ chế phân số và thang nâng cơ học | roadmap_Tao_do_choi_0-25_tuoi.md |
| roi_ngon_tay_nhan_vat_giao_thieu_nhi | Chế tạo bộ rối ngón tay giao tiếp xã hội | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_busy_board_dap_dinh_nhua_xien_chot | Chế tạo bảng busy board đập đinh nhựa và chốt xoay | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_logic_toan_ngon_ngu_p1_cat_phoi | Capstone Bộ đồ chơi logic toán & rối kể chuyện - P1: Cắt phôi | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_logic_toan_ngon_ngu_p2_lap_rap | Capstone Bộ đồ chơi logic toán & rối kể chuyện - P2: Lắp ráp | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_logic_toan_ngon_ngu_p3_hoan_thien | Capstone Bộ đồ chơi logic toán & rối kể chuyện - P3: Hoàn thiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_do_choi_giao_thong_logic | Kỹ thuật thiết kế đồ chơi mô hình giao thông logic | roadmap_Tao_do_choi_0-25_tuoi.md |
| bang_giao_thong_ranh_truot_xe_logic | Bảng giao thông rãnh trượt xe di chuyển logic | roadmap_Tao_do_choi_0-25_tuoi.md |
| hop_phan_loai_bien_bao_va_phuong_tien | Hộp phân loại biển báo giao thông và phương tiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| duong_ray_bong_lan_deo_doc_deo_nhat | Đường ray bóng lăn mô phỏng đèo dốc núi ziczac | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_thiet_ke_do_choi_giao_thong_va_co_che_dieu_huong | Ôn tập thiết kế đồ chơi giao thông và cơ chế điều hướng | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_khieu_khi_nen_ong_dan_an_toan | Kỹ thuật đấu nối ống dẫn khí và van khí nén cơ bản | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_phan_luc_bong_bong_khi_nen | Chế tạo xe phản lực chuyển động bằng khí nén | roadmap_Tao_do_choi_0-25_tuoi.md |
| nguyen_ly_thuy_luc_xilanh_xirang | Nguyên lý truyền lực truyền chất lỏng qua hệ thống xi-lanh thủy lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| canh_tay_thuy_luc_2_truc | Kỹ thuật lắp ráp cánh tay thủy lực 2 trục gắp vật nhẹ | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_co_che_khi_nen_va_thuy_luc | Ôn tập cơ chế truyền động khí nén và thủy lực ứng dụng | roadmap_Tao_do_choi_0-25_tuoi.md |
| mach_dien_dc_led_don_gian | Thiết kế mạch điện DC cơ bản: Pin, công tắc và bóng đèn LED | roadmap_Tao_do_choi_0-25_tuoi.md |
| may_chieu_mini_thau_kinh_led | Ứng dụng mạch điện chiếu sáng chế tạo máy chiếu mini | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_dong_co_dc_truyen_dong_day_thung | Lắp ráp xe chạy động cơ DC kết hợp truyền động dây curoa/dây chun | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_xe_canh_tay_stem_p1_thiet_ke_cat_phoi | Capstone 11: Xe gắp thủy lực điện tử - Phần 1: Thiết kế và Cắt phôi | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_xe_canh_tay_stem_p2_lap_rap_hoan_thien | Capstone 11: Xe gắp thủy lực điện tử - Phần 2: Lắp ráp & Hoàn thiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_thuyen_chan_vit_co_hoc | Kỹ thuật thiết kế thuyền chân vịt cơ học | roadmap_Tao_do_choi_0-25_tuoi.md |
| thuyen_may_motor_dc_chan_vit_mini | Chế tạo thuyền máy mini dùng động cơ DC | roadmap_Tao_do_choi_0-25_tuoi.md |
| may_phat_dien_quay_tay_led | Chế tạo máy phát điện quay tay phát sáng LED | roadmap_Tao_do_choi_0-25_tuoi.md |
| quat_gio_nang_luong_mat_troi_mini | Chế tạo quạt gió năng lượng mặt trời mini | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_co_che_dong_co_dc_va_tai_tao_nang_luong | Ôn tập cơ chế động cơ DC và tái tạo năng lượng | roadmap_Tao_do_choi_0-25_tuoi.md |
| ong_kinh_van_hoa_khuc_xao_anh_sang | Chế tạo ống kính vạn hoa khúc xạ ánh sáng & Xử lý lệch ảnh | roadmap_Tao_do_choi_0-25_tuoi.md |
| den_ngu_chieu_sao_xoay_tu_dong | Chế tạo đèn ngủ chiếu bầu trời sao xoay tự động & Chẩn đoán lệch trục | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_he_thong_stem_tong_hop_p1_thiet_ke_khung | Capstone: Hệ thống cối xay gió & thang nâng STEM (Phần 1: Thiết kế, Cắt phôi & Lập BOM) | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_he_thong_stem_tong_hop_p2_lap_mach_dien_thuy_luc | Capstone: Hệ thống cối xay gió & thang nâng STEM (Phần 2: Mạch điện & Thủy lực) | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_he_thong_stem_tong_hop_p3_kiem_dinh_hoan_thien | Capstone: Hệ thống cối xay gió & thang nâng STEM (Phần 3: Kiểm định & Đánh giá độ bền) | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_truc_cam_va_co_cau_lien_ket | Kỹ thuật thiết kế trục cam và cơ cấu liên kết thanh truyền | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_con_thu_nhun_nhay_truc_cam | Chế tạo mô hình con thú nhún nhảy bằng trục cam cơ học | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_thang_nang_thuy_luc_dang_keo | Chế tạo mô hình thang nâng thủy lực dạng kéo (Scissor Lift) | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_xe_khi_nen_piston_xilanh | Chế tạo xe khí nén sử dụng xi-lanh đẩy bánh xe | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_co_cau_truc_cam_va_truyen_dong_ap_suat | Ôn tập cơ cấu trục cam, liên kết thanh truyền và thủy - khí nén | roadmap_Tao_do_choi_0-25_tuoi.md |
| may_hut_bui_mini_dong_co_dc | Chế tạo máy hút bụi mini cầm tay từ mô-tơ DC và quạt hút | roadmap_Tao_do_choi_0-25_tuoi.md |
| robot_rua_bo_mach_dien_dao_chieu | Chế tạo robot rùa bò có mạch điện công tắc gạt đảo chiều | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_robot_thuy_luc_dien_dc_p1_khung_layout | Capstone Robot thủy lực kết hợp mạch DC - P1: Thiết kế khung & cắt phôi | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_robot_thuy_luc_dien_dc_p2_lap_rap | Capstone Robot thủy lực kết hợp mạch DC - P2: Lắp ráp cơ khí & mạch điện | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_robot_thuy_luc_dien_dc_p3_kiem_dinh | Capstone Robot thủy lực kết hợp mạch DC - P3: Kiểm định & hoàn thiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_banh_rang_va_hop_so | Kỹ thuật thiết kế bánh răng và hộp số cơ quan truyền lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_dua_dong_co_day_thun_banh_rang | Chế tạo xe đua tích năng lượng dây thun với hộp số tăng tốc | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_can_cau_thuy_luc_xoay | Chế tạo cẩu trục thủy lực xoay 360 độ điều khiển bằng xi-lanh | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_co_cau_banh_rang_va_thuy_luc_da_truc | Ôn tập cơ cấu bánh răng truyền động và ứng dụng thủy lực đa trục | roadmap_Tao_do_choi_0-25_tuoi.md |
| may_thoi_bong_bong_xa_phong_dc | Chế tạo máy thổi bong bóng xà phòng tự động bằng động cơ DC | roadmap_Tao_do_choi_0-25_tuoi.md |
| thuyen_buom_dong_co_pin_mat_troi | Chế tạo thuyền máy hai thân dùng pin năng lượng mặt trời | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_day_chuyen_tu_dong_p1_khung_bang_tai | Capstone: Dây chuyền sản xuất tự động mini - Phần 1: Khung và băng tải | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_day_chuyen_tu_dong_p2_mach_dien_thuy_luc | Capstone: Dây chuyền sản xuất tự động mini - Phần 2: Động cơ DC và tay gạt thủy lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_day_chuyen_tu_dong_p3_kiem_dinh_hoan_thien | Capstone: Dây chuyền sản xuất tự động mini - Phần 3: Tối ưu và kiểm định | roadmap_Tao_do_choi_0-25_tuoi.md |
| tong_ket_danh_gia_stem_dong_luc_hoc_dien_co | Tổng kết và đánh giá toàn bộ Phase 3 Đồ chơi STEM Động lực học & Mạch điện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_mo_hinh_giao_thong_stem | Kỹ thuật thiết kế mô hình giao thông STEM thông minh | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_den_giao_thong_mach_3_mau | Chế tạo mô hình đèn giao thông 3 màu với công tắc xoay | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_rao_chan_barie_thuy_luc | Chế tạo rào chắn barie giao thông nâng hạ thủy lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_he_thong_dieu_khien_giao_thong_stem | Ôn tập hệ thống điều khiển giao thông tích hợp mạch điện và thủy lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_may_phat_dien_gio_canh_quạt | Chế tạo máy phát điện gió cơ bản thắp sáng đèn LED | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_xe_vong_xoay_quan_tinh | Chế tạo xe cơ học truyền động bánh đà quán tính | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_mo_hinh_thanh_pho_stem_p1_khung_ha_tang | Capstone Mô hình thành phố STEM: P1 - Thiết kế hạ tầng & sa bàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_mo_hinh_thanh_pho_stem_p2_mach_dien_khi_nen | Capstone Mô hình thành phố STEM: P2 - Lắp ráp mạch điện & hệ thống cơ thủy lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_mo_hinh_thanh_pho_stem_p3_hoan_thien_testing | Capstone Mô hình thành phố STEM: P3 - Kiểm định vận hành & hoàn thiện thẩm mỹ | roadmap_Tao_do_choi_0-25_tuoi.md |
| tong_ket_danh_gia_phan_STEM_dong_luc_hoc_nang_cao | Tổng kết & đánh giá toàn bộ Phase STEM Động lực học, Thủy lực & Mạch điện | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_phan_luc_tai_che_vo_chai | Chế Tạo Xe Phản Lực Khí Nén Từ Chai Nhựa Tái Chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| canh_tay_robot_thuy_luc_carton | Chế Tạo Cánh Tay Robot Thủy Lực Từ Bìa Carton | roadmap_Tao_do_choi_0-25_tuoi.md |
| mach_dien_dc_cong_tac_tu_che | Lắp Mạch Điện DC Cơ Bản Có Công Tắc Từ Đồ Tái Chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_stem_tai_che_tong_hop | Capstone: Tổng Hợp Mô Hình Xe STEM Đa Năng Tái Chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_phan_luc_khi_vo_chai_tai_che | Chế tạo xe phản lực khí nén từ vỏ chai và chẩn đoán sự cố cơ học | roadmap_Tao_do_choi_0-25_tuoi.md |
| canh_tay_thuy_luc_carton_xilanh_mini | Chế tạo cánh tay robot thủy lực từ bìa carton và kỹ thuật xả bọt khí | roadmap_Tao_do_choi_0-25_tuoi.md |
| may_chieu_phim_mini_kinh_lup_hop_giay | Chế tạo máy chiếu phim mini và điều chỉnh tiêu cự khúc xạ quang học | roadmap_Tao_do_choi_0-25_tuoi.md |
| mach_dien_dc_cong_tac_la_dong_tai_che | Chế tạo mạch điện DC với công tắc kẹp giấy và chẩn đoán sụt áp | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_stem_tai_che_tong_hop_v2 | Hoàn thiện, kiểm định an toàn và hạch toán chi phí bộ đồ chơi STEM tái chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_phan_luc_khi_nap_mo_ong_hut | Thử nghiệm xe chạy bằng phản lực khí nén van nắp mở và chẩn đoán kẹt bánh | roadmap_Tao_do_choi_0-25_tuoi.md |
| canh_tay_robot_thuy_luc_kep_co_hoc | Chế tạo cánh tay robot thủy lực 2 xilanh kẹp đồ và xử lý rò rỉ bọt khí | roadmap_Tao_do_choi_0-25_tuoi.md |
| may_chieu_phim_mini_hop_carton_kinh_lup | Chế tạo máy chiếu phim mini carton điều chỉnh tiêu cự và chống phản quang | roadmap_Tao_do_choi_0-25_tuoi.md |
| mach_dien_dc_led_cong_tac_gim_giay | Lắp ráp mạch điện DC công tắc ghim giấy và chẩn đoán lỏng mối nối | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_mo_hinh_stem_tai_che_da_co_cau | Capstone: Báo cáo, tinh chỉnh và hoàn thiện mô hình STEM tái chế đa cơ cấu | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_phan_luc_khi_nen_banh_nhua_tai_che | Chế Tạo Xe Phản Lực Khí Nén Từ Vỏ Chai Và Nắp Nhựa Tái Chế (Kèm Xử Lý Lỗi) | roadmap_Tao_do_choi_0-25_tuoi.md |
| canh_tay_thuy_luc_carton_gap_do | Chế Tạo Cánh Tay Robot Thủy Lực Gắp Vật Thể Tái Chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| may_chieu_mini_hop_giay_kinh_lup_led | Lắp Ráp Máy Chiếu Phim Mini Từ Hộp Giấy Và Thấu Kính Kính Lúp | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_co_cau_khi_nen_thuy_luc_mach_dc_tai_che | Ôn Tập Tổng Hợp & Quy Trình Xử Lý Sự Cố (Troubleshooting) Mô Hình STEM | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_mo_hinh_stem_co_dien_thuy_luc_tai_che | Capstone: Hoàn Thiện & Đánh Giá Sa Bàn STEM Đa Cơ Cấu Tái Chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_phan_luc_khi_bong_bong_nap_nhua | Chế tạo xe phản lực khí nén từ bóng bóng và nắp chai nhựa | roadmap_Tao_do_choi_0-25_tuoi.md |
| canh_tay_robot_thuy_luc_2_piston_carton | Chế tạo cánh tay robot thủy lực 2 trục kẹp đồ từ bìa carton | roadmap_Tao_do_choi_0-25_tuoi.md |
| may_chieu_phim_mini_kinh_lup_hop_giay_led | Chế tạo máy chiếu phim mini từ kính lúp và hộp giày cũ | roadmap_Tao_do_choi_0-25_tuoi.md |
| mach_dien_dc_cong_tac_gim_giay_tai_che | Lắp ráp mạch điện DC cơ bản dùng công tắc ghim bấm tái chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_do_choi_stem_co_dien_thuy_luc_tai_che_hoan_chinh | Capstone: Hoàn thiện mô hình STEM tổng hợp cơ điện thủy lực tái chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_phan_luc_khi_vo_chai_bong_bay | Thiết kế xe phản lực khí nén từ vỏ chai, bóng bay và xử lý sự cố ma sát | roadmap_Tao_do_choi_0-25_tuoi.md |
| canh_tay_robot_thuy_luc_carton_xilanh | Chế tạo cánh tay robot thủy lực carton nâng hạ bằng xilanh và xả bọt khí | roadmap_Tao_do_choi_0-25_tuoi.md |
| may_chieu_phim_mini_kinh_lup_carton | Lắp ráp máy chiếu phim mini từ kính lúp, hộp carton và tinh chỉnh tiêu cự | roadmap_Tao_do_choi_0-25_tuoi.md |
| mach_dien_dc_don_gian_gim_giay | Thiết kế mạch điện DC đơn giản với công tắc ghim giấy và chẩn đoán hở mạch | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_mo_hinh_stem_tai_che_dieu_khien | Capstone: Hoàn thiện, kiểm định và xử lý sự cố bộ đồ chơi STEM tái chế | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_gian_giang_chiu_luc_palsa | Kỹ thuật lắp ráp kết cấu giàn giằng chịu lực khung tam giác | roadmap_Tao_do_choi_0-25_tuoi.md |
| cau_gian_giang_vom_tam_giac | Chế tạo mô hình cầu giàn giằng chịu lực vòm tam giác | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_thiet_ke_cau_gian_giang | Ôn tập và kiểm định tải trọng cầu giàn giằng | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_dung_khung_nha_mini | Kỹ thuật cắt đục và dựng khung mô hình nhà cửa mini | roadmap_Tao_do_choi_0-25_tuoi.md |
| trang_tri_mo_hinh_nha_thu_nho | Trang trí nội ngoại thất và lắp mái cho mô hình nhà mini | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_board_game_logic | Thiết kế cơ chế chơi, quy tắc Board Game trí tuệ và cân bằng logic | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tao_quan_co_the_bai_board_game | Chế tạo quân cờ, thẻ bài sự kiện và ứng dụng tạo khuôn silicone nhân bản chi tiết | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_tri_tue_p1_ban_co | Capstone Board Game - Phần 1: Thiết kế, sản xuất Bàn Cờ gập và hạch toán BOM | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_tri_tue_p2_phu_kien_luat | Capstone Board Game - Phần 2: Đóng sổ luật chơi, khay định hình và hộp đựng | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_tri_tue_p3_playtest_hoan_thien | Capstone Board Game - Phần 3: Playtest, xử lý sự cố cân bằng và hoàn thiện thương phẩm | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_cau_day_vang_chiu_luc | Kỹ thuật thiết kế và tính toán phân bổ lực cầu dây văng | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_biet_thu_2_tang_khung_dinh_hinh | Kỹ thuật dựng khung và chia không gian biệt thự 2 tầng | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_board_game_dia_hinh_3d | Thiết kế bàn cờ chiến thuật mô-đun địa hình 3D | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_thu_tai_ket_cau_va_can_bang_game | Ôn tập kiểm định kết cấu chịu tải và cân bằng game | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_mo_hinh_thanh_pho_board_game_3d | Capstone: Sản xuất trọn bộ Board Game Chiến Thuật Thành Phố 3D | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_cat_ghep_go_balsa_truc_thuong | Kỹ thuật cắt ghép gỗ balsa chịu tải trọng đứng & xử lý bong mối dán | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_vom_cau_la_ma_tu_khoa_luc | Thiết kế mô hình cầu vòm La Mã cơ chế tự khóa & chẩn đoán xô lệch lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_board_game_co_xay_chien_thuat | Kỹ thuật thiết kế board game chiến thuật chuyển động quay & xử lý kẹt khớp | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_phan_tich_ung_suat_ket_cau_va_can_bang_game | Ôn tập phân tích ứng suất kết cấu, cân bằng game & chẩn đoán lỗi mô hình | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_kien_truc_3d_p1_khung_de | Capstone: Board Game Kiến Trúc 3D - P1: Khung đòn chịu tải & Định mức BOM | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_kien_truc_3d_p2_chi_tiet_va_the_bai | Capstone Board Game Kiến Trúc 3D - P2: Chế Tạo Khối Xây Và Thẻ Bài | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_kien_truc_3d_p3_luat_choi_va_playtest | Capstone Board Game Kiến Trúc 3D - P3: Viết Luật Chơi & Playtest | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_kien_truc_3d_p4_hoan_thien_dong_hop | Capstone Board Game Kiến Trúc 3D - P4: Hoàn Thiện Và Đóng Hộp | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_mo_phong_dong_dat_cho_mo_hinh | Kỹ Thuật Làm Bàn Rung Mô Phỏng Động Đất Cho Mô Hình Kiến Trúc | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_kiem_dinh_ket_cau_va_game_design | Ôn Tập Kiểm Định Kết Cấu Chịu Lực & Cân Bằng Game Design | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_gia_co_luoi_tam_giac_chiu_luc | Kỹ thuật gia cố lưới tam giác chịu lực cho khung kiến trúc | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_thap_truyen_thong_balsa_cao_tang | Chế tạo mô hình tháp balsa cao tầng chịu lực nén thẳng đứng | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_board_game_quan_ly_tai_nguyen | Kỹ thuật thiết kế cơ chế quản lý tài nguyên trong Board Game | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_phan_tich_luc_truc_va_can_bang_game_kinh_te | Ôn tập phân tích ứng suất kết cấu và cân bằng cơ chế kinh tế game | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_xay_dung_thanh_pho_p1 | Capstone Board Game Xây Dựng Thành Phố - Phần 1: Thiết kế bản đồ & ô cờ | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_xay_dung_thanh_pho_p2 | Capstone Board Game Xây Dựng Thành Phố P2: Bản Đồ Địa Hình Và Công Trình 3D | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_xay_dung_thanh_pho_p3 | Capstone Board Game Xây Dựng Thành Phố P3: Thẻ Bài Và Token Tài Nguyên | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_xay_dung_thanh_pho_p4 | Capstone Board Game Xây Dựng Thành Phố P4: Thử Nghiệm Cân Bằng Game | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_xay_dung_thanh_pho_p5 | Capstone Board Game Xây Dựng Thành Phố P5: Hoàn Thiện Hộp Đựng Và Sách Luật | roadmap_Tao_do_choi_0-25_tuoi.md |
| tong_ket_danh_gia_board_game_kien_truc | Tổng Kết Đánh Giá Module Mô Hình Kiến Trúc & Board Game Trí Tuệ | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_gian_giang_warren_va_howe | Kỹ thuật thiết kế giàn giằng Warren và Howe chịu tải trọng lớn và xử lý biến dạng | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_nha_xanh_mo_dun_thiet_ke | Thiết kế mô hình nhà ở sinh thái mô-đun tháo lắp và tối ưu khớp nối | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_board_game_dat_quan_va_chon_the | Kỹ thuật thiết kế Board Game cơ chế đặt quân và rút thẻ chiến thuật | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_thu_tai_gian_giang_va_playtest_game | Ôn tập kiểm định tải trọng cầu giàn, playtest và chẩn đoán sự cố Board Game | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_xay_cau_kien_truc_hoan_chinh | Chế tạo hoàn chỉnh bộ Board Game 'KTS Trưởng: Đại Chiến Cầu Giàn' | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_gian_giang_pratt_chiu_luc | Kỹ thuật giàn giằng Pratt trong thiết kế cầu chịu lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_biet_thu_san_vuon_ti_le | Thiết kế mô hình biệt thự sân vườn tỉ lệ 1:50 | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_board_game_worker_placement | Kỹ thuật thiết kế Board Game phong cách Worker Placement | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_suc_ben_ket_cau_va_can_bang_board_game | Ôn tập kiểm tra sức bền kết cấu cầu và độ cân bằng Board Game | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_kien_truc_xay_cau_p1 | Capstone Board Game Kiến Trúc P1: Thiết kế & Cắt phôi | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_kien_truc_xay_cau_p2 | Capstone Board Game Xây Cầu P2: Chế Tạo Mảnh Giàn Giằng Va Thẻ Bài Hành Động | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_kien_truc_xay_cau_p3 | Capstone Board Game Xây Cầu P3: Lắp Ráp Mô Hình Cầu Mẫu Va Khung Game | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_kien_truc_xay_cau_p4 | Capstone Board Game Xây Cầu P4: Thử Nghiệm Playtest Va Cân Bằng Luật | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_kien_truc_xay_cau_p5 | Capstone Board Game Xây Cầu P5: Kiểm Định Sức Chịu Lực Va Đóng Hộp | roadmap_Tao_do_choi_0-25_tuoi.md |
| tong_ket_danh_gia_board_game_xay_cau | Ôn Tập Đánh Giá Toàn Diện Kỹ Thuật Mô Hình Va Board Game Chịu Lực | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_gian_giang_k_truss_chiu_luc | Kỹ thuật thiết kế giàn giằng K-Truss chịu tải trọng tĩnh | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_nha_phong_xanh_mo_dun_3d | Thiết kế mô hình nhà phố hiện đại xếp chồng mô-đun | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_board_game_co_che_area_control | Kỹ thuật thiết kế Board Game cơ chế chiếm lĩnh khu vực | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_ket_cau_k_truss_va_co_che_area_control | Ôn tập độ bền K-Truss và thử nghiệm tính cân bằng Area Control | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_do_thi_tuong_lai | Capstone: Bộ Board Game Kiến Trúc 'KTS Đô Thị Tương Lai' | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_gian_giang_fink_chiu_luc | Kỹ thuật giàn giằng Fink chịu tải mái nhà | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_chung_cu_xanh_modun_3d | Mô hình căn hộ xanh mô-đun xếp chồng 3D | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_board_game_deck_building | Kỹ thuật thiết kế Board Game cơ chế Deck-Building | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_ket_cau_fink_va_deck_building | Ôn tập kết cấu giàn Fink và cân bằng Deck-Building | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_board_game_thanh_pho_xanh | Capstone: Board Game Xây Dựng Thành Phố Xanh 3D | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_cam_truc_automata | Kỹ thuật thiết kế cam tròn và thanh truyền cho đồ chơi Automata | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_automata_chim_vo_cang | Mô hình chim vỗ cánh chuyển động Automata cam tròn | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_tao_hinh_cam_bien_dang | Kỹ thuật tạo hình cam quả lê và cam hình tim tạo nhịp điệu | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_automata_nguoi_danh_dan | Mô hình Automata người đánh đàn với biên dạng cam hỗn hợp | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_co_cau_cam_dia_va_truyen_dong_automata | Ôn tập cơ cấu cam đĩa và truyền động chuyển động Automata | roadmap_Tao_do_choi_0-25_tuoi.md |
| tich_hop_dong_co_dc_giam_toc_automata | Kỹ thuật tích hợp động cơ DC giảm tốc truyền động cam và xử lý sự cơ khí | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_hop_am_nhac_automata_dong_co_dc | Mô hình Automata rồng phun lửa chạy động cơ DC giảm tốc và cân chỉnh cam kép | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_automata_da_truc_p1_khung_cam | Capstone Automata đa trục P1: Thiết kế khung, cắt phôi cam đĩa và hạch toán chi phí BOM | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_automata_da_truc_p2_lap_rap_dong_co | Capstone Automata đa trục P2: Lắp ráp cơ cấu trục cam, động cơ DC và mạch quản lý nguồn | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_automata_da_truc_p3_kiem_dinh_hoan_thien | Capstone Automata đa trục P3: Kiểm định độ mỏi chuyển động, khắc phục sự cố và hoàn thiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_lap_trinh_vi_dieu_khien_don_gian | Kỹ thuật lập trình vi điều khiển Nano đơn giản cho đồ chơi | roadmap_Tao_do_choi_0-25_tuoi.md |
| mach_cam_bien_anh_sang_ldr_dong_co | Mạch cảm biến ánh sáng LDR điều khiển động cơ Automata | roadmap_Tao_do_choi_0-25_tuoi.md |
| mach_cam_bien_sieu_am_vat_can | Mạch cảm biến siêu âm đo khoảng cách phát hiện vật cản | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_tich_hop_cam_bien_va_co_cau_co_khi | Ôn tập tích hợp cảm biến với cơ cấu cam Automata | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_automata_thong_minh_cam_bien_hong_ngoai | Mô hình Automata thông minh kích hoạt bằng cảm biến hồng ngoại | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_dieu_khien_dong_co_dc_cau_h | Kỹ thuật điều khiển động cơ DC với driver cầu H | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_robot_mini_do_duong_cam_bien | Chế tạo xe robot mini dò đường bằng cảm biến hồng ngoại | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_xe_thong_minh_p1_khung_dong_co | Capstone Xe Thông Minh Né Vật Cản - P1: Khung Xe & Động Cơ | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_xe_thong_minh_p2_lap_trinh_mach | Capstone Xe Thông Minh Né Vật Cản - P2: Lập Trình & Mạch Điện | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_xe_thong_minh_p3_kiem_dinh_hoan_thien | Capstone Xe Thông Minh Né Vật Cản - P3: Kiểm Định & Hoàn Thiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_dieu_khien_xe_qua_bluetooth | Kỹ thuật lập trình mô-đun Bluetooth HC-05 và xử lý sự cố kết nối | roadmap_Tao_do_choi_0-25_tuoi.md |
| xe_dieu_khien_bluetooth_app_mini | Chế tạo xe robot mini điều khiển qua Bluetooth sử dụng driver TB6612FNG/L298N | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_dieu_khien_dong_co_servo_sg90 | Kỹ thuật điều khiển động cơ Servo SG90 tạo góc quay chính xác và xử lý rung giật | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_lap_trinh_dieu_khien_servo_va_bluetooth | Ôn tập tích hợp Servo, mô-đun không dây, động cơ DC và chẩn đoán lỗi hệ thống | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_xe_automata_thong_minh_p1_khung_co_cau | Capstone Xe Automata Thông Minh P1: Lắp ráp khung xe, gá Servo và thiết kế cơ khí | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_xe_automata_thong_minh_p2_mach_cam_bien | Capstone Xe Automata Thông Minh - Phần 2: Lắp Mạch Điều Khiển, Driver & Module Bluetooth | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_xe_automata_thong_minh_p3_lap_trinh_dieu_khien | Capstone Xe Automata Thông Minh - Phần 3: Lập Trình Điều Khiển Bluetooth & Servo Automata | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_xe_automata_thong_minh_p4_kiem_dinh_hoan_thien | Capstone Xe Automata Thông Minh - Phần 4: Kiểm Định, Chẩn Đoán Sự Cố & Vận Hành | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_tong_hop_lap_trinh_mach_dien_automata | Ôn Tập Tổng Hợp Mạch Điện Tử, Cơ Khí Automata & Hạch Toán Chi Phí | roadmap_Tao_do_choi_0-25_tuoi.md |
| tong_ket_danh_gia_phase_mach_dien_tu_automata | Tổng Kết & Đánh Giá Phase Mạch Điện Tử, Automata & Mô Hình Thông Minh | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_tich_hop_man_hinh_oled_vi_dieu_khien | Kỹ thuật giao tiếp màn hình OLED I2C với vi điều khiển | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_automata_hien_thi_oled_cam_bien | Chế tạo Automata đo khoảng cách hiển thị màn hình OLED | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_lap_trinh_esp8266_wifi_dieu_khien | Kỹ thuật lập trình vi điều khiển ESP8266 điều khiển qua Wi-Fi | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_tich_hop_vi_dieu_khien_va_co_khi_thong_minh | Ôn tập tích hợp vi điều khiển, cảm biến và động cơ Automata | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_xe_automata_thong_minh_iot_hoan_thien | Capstone: Mô hình xe Automata thông minh điều khiển Wi-Fi & OLED | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_dieu_khien_song_rf_433mhz_cho_mo_hinh | Kỹ Thuật Điều Khiển Bằng Sóng RF 433MHz Cho Mô Hình | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_xe_automata_dieu_khien_tu_xa_rf | Mô Hình Xe Automata Điều Khiển Từ Xa Bằng RF | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_giao_thuyet_truyen_thong_khong_day_trong_mo_hinh | Ôn Tập Các Giao Thức Truyền Thông Không Dây Cho Mô Hình | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_robot_automata_iot_p1_khung_co_khi | Capstone Robot Automata IoT: Phần 1 - Khung Cơ Khí & Cơ Cầu Cam | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_robot_automata_iot_p2_lap_rap_mach_dieu_khien | Capstone Robot Automata IoT: Phần 2 - Nối Mạch & Kiểm Thử | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_robot_automata_iot_p3_lap_trinh_firmware | Capstone Robot Automata IoT P3: Lập trình firmware Blynk IoT / Web Server và ứng dụng điều khiển | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_robot_automata_iot_p4_kiem_dinh_hoan_thien | Capstone Robot Automata IoT P4: Kiểm định, an toàn pin Lithium BMS và tinh chỉnh Robot | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_thiet_ke_automata_va_vi_dieu_khien_thong_minh | Ôn tập kỹ thuật cơ khí Automata, an toàn nguồn pin BMS và Lập trình mạch vi điều khiển | roadmap_Tao_do_choi_0-25_tuoi.md |
| kiem_thu_do_ben_va_do_chinh_xac_mo_hinh_automata | Kiểm thử độ bền cơ khí, độ trễ tín hiệu và hạch toán định mức nguyên vật liệu (BOM) | roadmap_Tao_do_choi_0-25_tuoi.md |
| tong_ket_phase_mach_dien_tu_automata_thong_minh | Tổng kết Phase Mạch Điện Tử & Mô Hình Automata Thông Minh | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_tich_hop_cam_bien_mpu6050_cho_automata | Kỹ thuật tích hợp cảm biến gia tốc MPU6050 cho mô hình Automata | roadmap_Tao_do_choi_0-25_tuoi.md |
| mo_hinh_automata_can_bang_tu_dong_mpu6050 | Mô hình Automata phản hồi chuyển động cơ khí theo cảm biến MPU6050 | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_dieu_khien_can_bang_va_giam_sat_goc_nghieng | Ôn tập điều khiển cân bằng và phản hồi góc nghiêng trong Automata | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_robot_can_bang_automata_p1_khung_mach | Capstone Robot Automata Cân Bằng P1: Khung cơ khí & Mạch điều khiển | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_robot_can_bang_automata_p2_lap_trinh_testing | Capstone Robot Automata Cân Bằng P2: Lập trình PID & Kiểm định | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_cat_mica_go_epoxy_den_ngu | Kỹ thuật cắt mica, phôi gỗ và an toàn trang bị PPE khi đổ epoxy tạo kiểu đèn ngủ decor | roadmap_Tao_do_choi_0-25_tuoi.md |
| den_ngu_go_epoxy_led_cam_ung | Chế tác đèn ngủ nghệ thuật gỗ epoxy tích hợp mạch LED cảm ứng và xử lý sự cố điện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_ghep_mong_go_ke_mo_dun | Kỹ thuật cắt tạo mộng gỗ tự do chế tạo kệ mô-đun treo tường | roadmap_Tao_do_choi_0-25_tuoi.md |
| ke_mo_dun_thong_minh_decor | Chế tác hệ thống kệ mô-đun thông minh kết hợp chốt nam châm và tính toán BOM | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_gia_cong_go_decor_va_led_art | Ôn tập kỹ thuật gia công gỗ decor nghệ thuật, kiểm tra an toàn LED và đánh giá độ bền mỏi | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_khi_dong_hoc_dieu_vai_du | Kỹ thuật ứng dụng khí động học chế tạo diều thể thao vải dù ripstop | roadmap_Tao_do_choi_0-25_tuoi.md |
| be_phong_ten_lua_nuoc_ap_suat | Thiết kế bệ phóng tên lửa nước khí nén áp suất có van khóa an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_may_va_khung_ghe_gap_dich_chuyen | Kỹ thuật may gia cường vải Canvas và ghép khung ghế dã ngoại xếp gọn | roadmap_Tao_do_choi_0-25_tuoi.md |
| den_bao_vintage_led_pin_sac_camping | Chế tác dụng cụ dã ngoại đa năng: Đèn bão vintage LED pin sạc 18650 an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_dung_cu_decor_outdoor_da_nang | Capstone: Chế tạo bộ sản phẩm Decor phòng & Dụng cụ Dã ngoại đa năng | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_do_keo_epoxy_keo_khoi_3d | Kỹ thuật đổ keo Epoxy Resin tạo khối decor và quy trình an toàn hóa chất | roadmap_Tao_do_choi_0-25_tuoi.md |
| den_ngu_epoxy_xuyen_sang_de_go | Chế tác đèn ngủ Resin Epoxy xuyên sáng đế gỗ tự nhiên và kỹ thuật mài bóng | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_cat_cnc_laser_go_plywood | Kỹ thuật thiết kế và ghép mô-đun Plywood bằng khớp âm dương | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_che_tac_do_decor_epoxy_va_plywood | Ôn tập quy trình chế tác đồ Decor Resin, kệ Plywood và lập bảng BOM chi phí | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_ke_decor_den_ngu_epoxy_p1 | Capstone: Kệ mô-đun kết hợp đèn ngủ Epoxy - Phần 1: Cắt khung và đúc khối Resin | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_ke_decor_den_ngu_epoxy_p2 | Capstone: Kệ mô-đun kết hợp đèn ngủ Epoxy - Phần 2: Đánh bóng, đi mạch LED & An toàn PPE | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_may_bat_tang_camping_chong_nuoc | Kỹ thuật thiết kế và may bạt tăng Tarp Camping chống nước | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_dieu_khi_dong_hoc_delta | Kỹ thuật thiết kế diều khí động học Delta gia cố sợi carbon | roadmap_Tao_do_choi_0-25_tuoi.md |
| be_phong_ten_lua_nuoc_van_khi_dong_ho_ap_suat | Chế tạo bệ phóng tên lửa nước 2 tầng có đồng hồ áp suất và van an toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_dung_cu_outdoor_da_nang_camping | Capstone: Bộ dụng cụ dã ngoại dã chiến Tarp, Diều & Bệ phóng - Hạch toán BOM & Troubleshooting | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_uon_cong_go_steam_bending | Kỹ thuật uốn cong gỗ mỏng bằng hơi nước làm khung đèn decor | roadmap_Tao_do_choi_0-25_tuoi.md |
| den_ngu_go_uon_cong_nghe_thuat | Chế tác đèn ngủ uốn cong nghệ thuật kết hợp tấm khuếch tán ánh sáng | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_noi_chot_go_dowel_joint | Kỹ thuật nối chốt âm dương dowel chế tạo kệ gỗ mô-đun thông minh | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_uon_go_va_ke_mo_dun_decor | Ôn tập kỹ thuật uốn gỗ nghệ thuật và tạo liên kết kệ mô-đun | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tac_bep_cui_da_ngoai_gap_gon | Thiết kế và chế tác bếp củi dã ngoại gấp gọn siêu nhẹ từ inox | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_che_tao_dieu_parafoil_khong_khung | Kỹ thuật thiết kế, may diều dù parafoil không khung và chẩn đoán lệch gió | roadmap_Tao_do_choi_0-25_tuoi.md |
| be_phong_ten_lua_nuoc_2_tang_mo_du | Chế tạo bệ phóng tên lửa nước 2 tầng tích hợp van xả áp nhanh và xử lý rò rỉ | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_dung_cu_outdoor_diy_p1 | Capstone: Bộ dụng cụ dã ngoại DIY - Phần 1: Chế tác bếp củi, bệ phóng và phụ kiện da Leathercraft | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_dung_cu_outdoor_diy_p2 | Capstone: Bộ dụng cụ dã ngoại DIY - Phần 2: May diều dù, tích hợp mạch LED và khắc phục lỗi | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_dung_cu_outdoor_diy_p3 | Capstone: Bộ dụng cụ dã ngoại DIY - Phần 3: Kiểm định độ bền mỏi, BOM và hoàn thiện thương phẩm | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_duc_resin_epoxy_go_decor | Kỹ thuật đúc Resin Epoxy đệm gỗ làm đèn ngủ decor nghệ thuật | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tac_dung_cu_gap_gon_camping | Chế tác dụng cụ đa năng cắm trại gấp gọn bằng thép và phôi gỗ | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_gia_cong_resin_epoxy_va_dung_cu_outdoor | Ôn tập quy trình gia công Resin Epoxy nghệ thuật và dụng cụ Outdoor | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_dung_cu_decor_outdoor_p1_khung_va_epoxy | Capstone DIY Decor & Outdoor - Phần 1: Gia công khung gỗ và đúc mặt Resin | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_dung_cu_decor_outdoor_p2_hoan_thien_kiem_dinh | Capstone DIY Decor & Outdoor - Phần 2: Lắp mạch LED, chốt gập và kiểm định | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_duc_resin_epoxy_decor_hoa_kho | Kỹ thuật đúc Resin Epoxy hoa khô làm đèn ngủ nghệ thuật & An toàn hóa chất | roadmap_Tao_do_choi_0-25_tuoi.md |
| thiet_ke_be_phong_ten_lua_nuoc_van_xa_an_toan | Kỹ thuật chế tạo bệ phóng tên lửa nước xả áp nhanh & Kiểm định an toàn áp suất | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_che_tac_epoxy_va_khi_dong_hoc_outdoor | Ôn tập chế tác Resin Epoxy nghệ thuật và bệ phóng tên lửa nước: Chẩn đoán lỗi & An toàn | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_kit_decor_outdoor_p1_khung_gia_cong | Capstone Bộ kit Decor Outdoor (Phần 1): Gia công khung đế, bệ phóng & Bảng hạch toán chi phí (BOM) | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_bo_kit_decor_outdoor_p2_lap_rap_danh_gia | Capstone Bộ kit Decor Outdoor (Phần 2): Lắp ráp hoàn thiện, test vận hành & Đánh giá độ bền mỏi | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_khac_laser_cam_bien_cham_den_ngu | Kỹ thuật khắc laser, cảm biến chạm và an toàn PPE cho đèn ngủ | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_thiet_ke_be_phong_ten_lua_nuoc_da_nong | Kỹ thuật thiết kế bệ phóng tên lửa nước đa nòng & chẩn đoán rò khí áp suất | roadmap_Tao_do_choi_0-25_tuoi.md |
| on_tap_tong_hop_decor_nghe_thuat_va_thiet_bi_outdoor_diy | Ôn tập tổng hợp chế tác decor nghệ thuật, thiết bị outdoor & khắc phục sự cố (Troubleshooting) | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_khong_gian_song_outdoor_p1_gia_cong | Capstone Trọn bộ Không gian Sống Outdoor - Phần 1: Gia công, Lập bảng BOM & Khung cơ khí | roadmap_Tao_do_choi_0-25_tuoi.md |
| capstone_khong_gian_song_outdoor_p2_hoan_thien | Capstone Trọn bộ Không gian Sống Outdoor - Phần 2: Kiểm định độ mỏi, An toàn & Hoàn thiện | roadmap_Tao_do_choi_0-25_tuoi.md |
| ky_thuat_tich_hop_tram_sac_nang_luong_den_ngu_outdoor | Kỹ thuật tích hợp trạm sạc năng lượng mặt trời và đèn ngủ outdoor | roadmap_Tao_do_choi_0-25_tuoi.md |
| che_tac_ban_decor_camping_xep_gon_da_nang | Chế tác bàn decor camping xếp gọn tích hợp giá treo đèn | roadmap_Tao_do_choi_0-25_tuoi.md |
...
| setup_git | Cài đặt Python, VS Code, Git & Tư duy lập trình | PythonRoadMapFull.md |
| interpreter_repl | Python Interpreter, REPL, Jupyter Notebook, IPython | PythonRoadMapFull.md |
| variables_types | Biến & Kiểu dữ liệu: int, float, str, bool, None | PythonRoadMapFull.md |
| operators | Phép tính số học, Toán tử so sánh, Toán tử logic | PythonRoadMapFull.md |
...
| conditionals | Câu lệnh điều kiện: if, elif, else, Ternary Operator | PythonRoadMapFull.md |
| loops | Vòng lặp for/while: range, enumerate, zip, break, continue, List Comprehension | PythonRoadMapFull.md |
| functions | Hàm: def, return, Default/Keyword/Positional args | PythonRoadMapFull.md |
| functions_adv | Hàm nâng cao: *args, **kwargs, Lambda, map, filter, reduce | PythonRoadMapFull.md |
| scope_legb | Phạm vi biến: Local, Enclosing, Global, Built-in (LEGB rule), nonlocal | PythonRoadMapFull.md |
...
| collections | Cấu trúc dữ liệu nâng cao: deque, heap, stack, queue (collections, heapq) | PythonRoadMapFull.md |
| oop_basic | OOP: Class, Object, __init__, Attributes, Methods, self | PythonRoadMapFull.md |
| oop_inheritance | OOP: Kế thừa (Inheritance), super(), Đa kế thừa (MRO) | PythonRoadMapFull.md |
...
| json_csv_yaml | JSON, CSV, YAML: đọc, ghi, parse với json, csv, pyyaml | PythonRoadMapFull.md |
| modules_packages | Module & Package: import, __name__, __all__, __init__.py, pip, venv, pyproject.toml | PythonRoadMapFull.md |
| stdlib_core | Thư viện chuẩn: os, sys, shutil, glob, re, datetime, math, random | PythonRoadMapFull.md |
| stdlib_adv | Thư viện chuẩn nâng cao: itertools, functools, contextlib, abc | PythonRoadMapFull.md |
...
| descriptor | Descriptor Protocol: __get__, __set__, __delete__ — cách @property hoạt động | PythonRoadMapFull.md |
...
| asyncio_adv | AsyncIO nâng cao: Queue, Semaphore, timeout, shield, TaskGroup, cancellation | PythonRoadMapFull.md |
| aiohttp | aiohttp: Async HTTP client/server, Session, WebSocket async | PythonRoadMapFull.md |
| solid | SOLID Principles trong Python — viết code sạch, dễ mở rộng | PythonRoadMapFull.md |
...
| tdd | TDD: Test-Driven Development — Red, Green, Refactor workflow | PythonRoadMapFull.md |
| coverage | Coverage: coverage.py, pytest-cov, Branch coverage, CI integration | PythonRoadMapFull.md |
| integration_e2e | Integration Testing, E2E Testing với pytest + Docker | PythonRoadMapFull.md |
| profiling | Profiling: cProfile, line_profiler, memory_profiler, Py-Spy | PythonRoadMapFull.md |
| optimization | Tối ưu Python: List vs Generator, local lookup, caching, micro-optim | PythonRoadMapFull.md |
| cython | Cython: Biên dịch Python sang C — tốc độ như C | PythonRoadMapFull.md |
| numba | Numba: JIT compilation, @jit, @njit, Parallel, GPU (CUDA) | PythonRoadMapFull.md |
| ctypes_cffi | ctypes, cffi: Gọi hàm C từ Python — Tích hợp C extension | PythonRoadMapFull.md |
| pypy | PyPy: Python nhanh hơn với JIT — Khi nào dùng PyPy vs CPython | PythonRoadMapFull.md |
...
| fastapi_testing | FastAPI: Testing với TestClient, pytest, Mock dependencies | PythonRoadMapFull.md |
...
| django_orm_adv | Django ORM nâng cao: select_related, prefetch_related, annotate, aggregate | PythonRoadMapFull.md |
...
| drf_adv | DRF nâng cao: Throttling, Pagination, Filtering, JWT với Simple JWT | PythonRoadMapFull.md |
...
| sql_adv | SQL nâng cao: JOIN, Subquery, CTE, Window Functions, Index, Explain | PythonRoadMapFull.md |
...
| postgresql | PostgreSQL nâng cao: JSONB, Full-text Search, pg_trgm, Partitioning | PythonRoadMapFull.md |
| mongodb | MongoDB với PyMongo/Motor: CRUD, Aggregation pipeline, Index | PythonRoadMapFull.md |
| redis | Redis với redis-py/aioredis: Cache, Pub/Sub, Stream, Sorted Set | PythonRoadMapFull.md |
| elasticsearch | Elasticsearch với Python: Indexing, Query DSL, Aggregation, Vector Search | PythonRoadMapFull.md |
...
| pandas_adv | Pandas nâng cao: groupby, merge/join, pivot_table, resample, apply, Styler | PythonRoadMapFull.md |
...
| polars | Polars: DataFrame nhanh hơn Pandas 10x — Lazy, Expressions, Streaming | PythonRoadMapFull.md |
...
| cnn | CNN: Convolution, Pooling, ResNet, VGG, EfficientNet — Image classification | PythonRoadMapFull.md |
| rnn_lstm | RNN, LSTM, GRU — Sequence modeling, NLP truyền thống | PythonRoadMapFull.md |
...
| nlp_basic | NLP cơ bản: Tokenization, Stopwords, Lemmatization, TF-IDF, Word2Vec | PythonRoadMapFull.md |
...
| local_llm | Ollama, LM Studio, vLLM: Chạy LLM local (Llama3, Mistral, Phi) | PythonRoadMapFull.md |
...
| kubeflow | Kubeflow, Vertex AI Pipelines: ML workflow orchestration trên cloud | PythonRoadMapFull.md |
...
| k8s_adv | Kubernetes nâng cao: HPA, StatefulSet, Helm, ArgoCD, Kustomize | PythonRoadMapFull.md |
| cicd | CI/CD: GitHub Actions, GitLab CI, Jenkins — Build, Test, Deploy | PythonRoadMapFull.md |
| terraform | Terraform: IaC — Provision AWS/GCP/Azure resources | PythonRoadMapFull.md |
| ansible | Ansible: Playbook, Role, Inventory, Modules — Configuration management | PythonRoadMapFull.md |
| aws | AWS Core: EC2, S3, RDS, VPC, IAM, Lambda, API Gateway, SQS, SNS | PythonRoadMapFull.md |
| boto3 | AWS SDK: boto3 — S3, DynamoDB, Lambda, SES, Rekognition, Textract | PythonRoadMapFull.md |
...
| kafka | Kafka với Python: Producer, Consumer, Avro, Schema Registry, Faust | PythonRoadMapFull.md |
| rabbitmq | RabbitMQ với pika/aio-pika: Exchange, Queue, Routing key, Dead letter | PythonRoadMapFull.md |
...
| pyspark | Apache Spark với PySpark: RDD, DataFrame, SQL, MLlib, Streaming | PythonRoadMapFull.md |
| airflow | Apache Airflow: DAG, Operator, Sensor, XCom, Connections, Plugins | PythonRoadMapFull.md |
| prefect_dagster | Prefect & Dagster: Modern data orchestration — Flow, Task, Asset | PythonRoadMapFull.md |
...
| packaging_exe | PyInstaller, cx_Freeze, Nuitka: Đóng gói Python thành EXE/app | PythonRoadMapFull.md |
...
| faststream | FastStream: Kafka/RabbitMQ/SQS handler theo phong cách FastAPI | PythonRoadMapFull.md |
...
| raspberrypi | Raspberry Pi với Python: GPIO, Camera, UART — Home Automation | PythonRoadMapFull.md |
| web3 | Web3.py: Ethereum, Smart Contract interaction, ABI, Transaction signing | PythonRoadMapFull.md |
| solana | Solana với Python: solders, solana-py, SPL Token, NFT minting | PythonRoadMapFull.md |
...
| quantum | Quantum Computing: Qiskit (IBM), PennyLane — Quantum circuits | PythonRoadMapFull.md |
...
| microservices | Microservices với Python: Service mesh, API gateway, Discovery | PythonRoadMapFull.md |
